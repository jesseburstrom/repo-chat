...
const appContainerBaseClasses =
  "flex flex-col h-screen bg-white border border-[#e7eaf3] overflow-hidden";
const appContainerNormalClasses =
  "w-[80%] mx-auto my-[30px] rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.08),_0_1px_3px_rgba(0,0,0,0.05)] h-[calc(100vh_-_60px)]";
const appContainerFullscreenClasses =
  "w-full max-w-none m-0 border-none rounded-none shadow-none h-screen";
...
const AppLayout: React.FC<AppLayoutProps> = ({
  ...
  const appContainerClasses = `${appContainerBaseClasses} ${
    isFullScreenView ? appContainerFullscreenClasses : appContainerNormalClasses
  }`;
  return (
